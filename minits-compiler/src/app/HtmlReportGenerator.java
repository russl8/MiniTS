...
public class HtmlReportGenerator {
    public static String generate(File file, String filePath, ExpressionProcessor ep,
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(outputPath))) {
            ...
            writer.println(
                    generateRightColumn(ep.vars, semanticErrors, filePath, inputFileContents, classes));
            writer.println("</div>");
